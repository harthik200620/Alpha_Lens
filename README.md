...
*Real-time quantitative trade signals driven by Google Gemini, live news analysis, and technical confirmation — built for NSE/BSE.*
...
The platform also ships with a full **backtesting engine** that replays historical news headlines against past market data to measure the AI's predictive accuracy over time.
...
└───────┬───────────────┬────────────────────┬──────────────────┘
   ...
   │ Worker  │   │ + Gemini AI │   │ (users, news)   │
   │ Thread  │   │   Thread    │   └─────────────────┘
   └─────────┘   └─────────────┘
        │               │
        ▼               ▼
   Live NSE/BSE    AI Trade Signals
   Price Data      + Technical Confirmation
```
...
1. **AI News Engine** — Continuously scrapes RSS feeds, analyzes headlines with Gemini, applies technical confirmation, and stores results in `news_cache.db`.
2. **yfinance Price Worker** — Monitors all active trade positions every 10 seconds, checking if targets or stop-losses have been hit.
...
<a href="https://github.com/KIRITO-899">
  <img src="https://github.com/KIRITO-899.png" width="60" style="border-radius:50%" alt="KIRITO-899"/>
</a>
<a href="https://github.com/RohanVellanki">
  <img src="https://github.com/RohanVellanki.png" width="60" style="border-radius:50%" alt="RohanVellanki"/>
</a>
<a href="https://github.com/Sumant-varanasi">
  <img src="https://github.com/Sumant-varanasi.png" width="60" style="border-radius:50%" alt="Sumant-varanasi"/>
</a>
